...
public class GameStateJsonParser {
	...
	public  static Board parseJson(String fileName, Board board){
	  ...
	  try{
		  Scanner inFile1;
			// System.out.println(new File(".").getAbsolutePath());
				inFile1 = new Scanner(new File(Global.SAVED_FILE_DIRECTORY_PATH + "/"+fileName+".json"));
     ...
     System.out.println(bank_amount);
              final JSONArray geodata = responseData.getJSONArray(Language.PLAYERS);
              ...
              for (int i = 0; i < n; ++i) {
	               ...
	               int tmp_player_personality_card = player.getInt(Language.PERSONALITY_CARD);
	               ...
	               String random_even_cards = player.getString(Language.RANDOM_CARDS);	               
	...
	public static List<Integer> get_integer_list(String green_cards){
		...
		String removeParenthesis=green_cards.substring(1,( green_cards.length()-1));
